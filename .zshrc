...
# source bash auto completion scripts
source $HOMEBREW_ROOT/share/zsh/site-functions/_az
source $HOMEBREW_ROOT/share/zsh/site-functions/_pip
source $HOMEBREW_ROOT/share/zsh/site-functions/_pyenv
...
function clean() {
    ...
    find $HOME -name '.DS_Store' -type f -delete 2>/dev/null -print
